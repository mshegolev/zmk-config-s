...
flash_half() {
    ...
    if [ $FORCE_MODE -eq 0 ]; then
        ...
        echo "   3. Проверь переключатель питания:"
        echo "      • Правая половинка: ON = вниз ⬇️"
        echo "      • Левая половинка:  ON = вверх ⬆️"
        echo "   4. Подключи USB только к: $half_name"
        echo "   5. Нажми 2 раза кнопку RESET на контроллере"
...
show_post_flash_help() {
    ...
    echo ""
    echo "1️⃣  Проверь переключатели питания:"
    echo "   • Правая половинка: ON = вниз ⬇️"
    echo "   • Левая половинка:  ON = вверх ⬆️"
    echo ""
    echo "2️⃣  Подключи TRRS кабель между половинами"
    echo "   ⚠️  ВАЖНО: TRRS должен быть надежно вставлен с обеих сторон"
    echo ""
    echo "3️⃣  Подключи USB к ЛЕВОЙ половине"
    echo "   💡 Левая половина = центральная (central)"
    echo "   💡 Правая половина = периферийная (peripheral)"
    echo ""
    echo "4️⃣  Подожди 5-10 секунд для инициализации"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
